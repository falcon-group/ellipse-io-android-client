...
@AndroidEntryPoint
class DeviceActivity : BaseActivity<BaseViewModel.EmptyViewModel>() {

    companion object {
        fun newIntent(context: Context) = Intent(context, DeviceActivity::class.java)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.beginTransaction()
            .replace(R.id.layoutFragment, DeviceFragment())
            .commit()
    }
}